...
namespace SharedResourcesExample
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
			...
			services.AddLocalization(options => options.ResourcesPath = "StringResources");

			services.AddMvc()
			  .AddViewLocalization(LanguageViewLocationExpanderFormat.Suffix, options => options.ResourcesPath = "StringResources")
